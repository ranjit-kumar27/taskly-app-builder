...
import com.ranjit.projects.Taskly.repository.PlanRepository;
import com.ranjit.projects.Taskly.repository.UserRepository;
import com.ranjit.projects.Taskly.security.AuthUtil;
import com.ranjit.projects.Taskly.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        User user = userRepository.findById(userId).orElseThrow(()->
                new  ResourceNotFoundException("User not find this Id: ",userId.toString()));
        ...
        try {
            ...
            Session session = Session.create(params.build());// Making aoi call to the strip backend
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        log.debug("Handling strip event: {}",type);
        ...
        switch (type) {
            ...
            case "customer.subscription.updated"->handleCustomerSubscriptionUpdated((Subscription) stripeObject);//when user cancels,upgrades or any
